...
public class SumLoveRankFragmentAdapter extends BaseAdapter{
	private Context context;
	private ArrayList<SumLoveRankFragmentModel> list = new ArrayList<SumLoveRankFragmentModel>();
	

	private DisplayImageOptions options;
	protected ImageLoader imageLoader = ImageLoader.getInstance();
	
	public SumLoveRankFragmentAdapter(Context context,ArrayList<SumLoveRankFragmentModel> arrayList){
	...
	public View getView(int position, View view, ViewGroup parent) {
		SumLoveRankFragmentModel NearContact = list.get(position);
		Item item = null;
		if(view==null){
			item = new Item();
		...
		item.ranknum.setText(""+NearContact.getRankNum());
