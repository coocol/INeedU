...
//	public static String SERVER_HOST = "192.168.191.10";//你openfire服务器所在的ip
//	public static  String SERVER_NAME = "ineedu.com";//设置openfire时的服务器名
    private static XMPPConnection connection = null;
    
	@SuppressLint("SdCardPath")
	private static void openConnection() throws ConnectException{
		try {
			if (null == connection || !connection.isAuthenticated()) {
				XMPPConnection.DEBUG_ENABLED = true;//开启DEBUG模式
				//配置连接
				ConnectionConfiguration config = new ConnectionConfiguration(
						Constant.XMPPHOST, Constant.XMPPPORT,
						Constant.XMPPNAME);
	...
	public static void closeConnection() {
		if(connection!=null){
			...
			Log.i("XMPP","XMPP Connection Has Disconnected!");
		}
		connection = null;
	}
	/**
